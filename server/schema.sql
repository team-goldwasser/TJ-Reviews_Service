...
COPY movies(movie_id, movie_title, title_url) FROM '/Users/soupuu/Desktop/RPT11/SDC/Project_Repos/TJ-Reviews_Service/data/seed_files/movieTitles.csv' DELIMITER ',' CSV HEADER;
